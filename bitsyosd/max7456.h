...
class OSD: public BetterStream
{
  public:
    ...
    void writeach(char* text, int s); 
    void writeupper(char* text);
    void writelower(char* text);
    void writedec(int d);
    void writefloat(float d, int prec);  
    void writexy(uint8_t x, uint8_t y, uint8_t c);  
